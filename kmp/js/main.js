...
$(function ($) {
   ...
   ==========================*/
    ...
    /*======================== 
        KMP News  
   ==========================*/
    if ($('.kmp_news').length > 0) {
        $('.kmp_news').owlCarousel({
            items: 3,
			rtl:true,
            dots: false,
            loop: true,
...
/*======================== 
   ...
   ==========================*/
	...
	/*======================== 
        Image slider 
   ==========================*/
    if ($('.kmp-image-slider').length > 0) {
        $('.kmp-image-slider').owlCarousel({
            items: 3,
			center: true,
            dots: false,
            loop: true,
	...
	/*======================== 
        Wanted slider 
   ==========================*/
    if ($('.wanted_slider').length > 0) {
        $('.wanted_slider').owlCarousel({
            items: 3,
   ...
   ==========================*/
	...
	/*======================== 
        Wanted slider 
   ==========================*/
    if ($('.remembar_slider').length > 0) {
        $('.remembar_slider').owlCarousel({
            items: 3,
