				...
				<div class='page'>						
					<table width='100%' border='0'>
						<tr>
							...
							<td style='text-align: justify'>								
								...
								বিষয়ঃ <strong>$lname</strong>র আবেদন।<br/><br/>
							</td>
							<td width='320px'>
                                                        <table style='width: 320px; font-size:0.75em; line-height: 1em; margin-top:-30px;'>
															<tr>
					...
					echo ") দিন</td>
						...
						<tr>
							<table border='1' cellpadding='7' cellspacing='0'>
							    <tr>
							        <th>ঠিকানা</th>
							        <th colspan='3'>ছুটির ধরণ</th>
							        <th>বিবরণ</th>
							        <th><small>"; if($q_cot_row32['section'] == '5' or $q_cot_row32['section'] == '6'){echo"আরও-১ ($ksection)";} else{echo"আর আই ($ksection)";} echo" মন্তব্য</small></th>
							        <th><small>এসি (ফোর্স) মন্তব্য</small></th>
							        <th>চূড়ান্ত<br/>আদেশ</th>
							    </tr>
								<tr>
									<td width='200px'>
										<strong><u>বর্তমান ঠিকানাঃ</u></strong><br/>$dname/";
										...
										<br/><br/><br/><br/>
										<strong><u>স্থায়ী ঠিকানাঃ</u></strong><br/>
										নামঃ $emp_name<br/>
										$add_permanent<br/>
										মোবাইল নং-";
					...
					echo "</span></th>
									<td style='text-align: justify'>
										...
										আপনার অধীনস্থ একজন পুলিশ কর্মচারী। বর্তমানে আমি <strong>$ksection</strong>, কেএমপি, খুলনায় কর্মরত আছি। 
					...
					echo "</strong>"; echo" (";echo num2bangla($wdate); echo") দিন <strong>$lname</strong> যাওয়া একান্ত প্রয়োজন।
										...
										<table style='line-height:18px;'>
											<tr>
												<td width='250px' style='text-align: left;'><strong>ছুটি ভোগের কারণঃ $lreson</strong><br/><br/>
											তারিখঃ ";
					echo bfn($appdate);
					echo "ইং
												</td>
									...
									<td width='140px' style='font-size: 0.9em;'><br/>$approver_rem1 <br/><img src='$sign_pic1'/><br/><small>$app_name1 (বিপি নং-"; echo bfn($app_bp1); echo ")<br/>"; echo bfn($app_date1); echo "</small></td>
									<td width='110px' style='font-size: 0.9em;'><br/>$approver_rem2 <br/><img src='$sign_pic2' /><br/><small>$app_name2 (বিপি নং-"; echo bfn($app_bp2); echo ")<br/>"; echo bfn($app_date2); echo "</small></td>
									<td width='100px' style='font-size: 0.9em;'><br/>$approver_rem3 <br/><img src='$sign_pic3''/><br/><small>$app_name3 (বিপি নং-"; echo bfn($app_bp3); echo ")<br/>"; echo bfn($app_date3); echo "</small></td>
								</tr>								
							</table>							
						</tr>
					</table>
