...
<?php echo $__env->make('front.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	function download(id)
		...
		// 	$.ajax({
        //     type:"GET",
        //     url:"<?php echo url(''); ?>/find_ajax_id/".+id,
		// 	datatype:'JSON',
		// 	error: function(xhr,status,error){
		// 		var errorMessage = xhr.status +':' + xhr.statusTest
		// 		alert(errorMessage);
		// 	}
		// 	success: function(data) {
		// 		alert('data paice kaku');
...
</html><?php /**PATH D:\wamp64\www\KMP-Development-final\resources\views/front/master.blade.php ENDPATH**/ ?>